...
import cr.ac.una.fantasydefender.controller.Controller;
...
public class FlowController {
            ...
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        ...
                        loader = new FXMLLoader(App.class.getResource("/cr/ac/una/fantasydefender/view/" + name + ".fxml"), this.idioma);
                        loader.load();
    ...
    try {
        FXMLLoader loader = new FXMLLoader(
            App.class.getResource("/cr/ac/una/fantasydefender/view/MainView.fxml"), 
            this.idioma
        );
        ...
        public void goMain(String acceso) {
            ...
            FXMLLoader loader = new FXMLLoader(
                App.class.getResource("/cr/ac/una/fantasydefender/view/" + acceso + "View.fxml"),
                this.idioma
            );
    ...
    private void applyIcon(Stage stage) {
        ...
        stage.getIcons().add(new Image(
                App.class.getResourceAsStream("/cr/ac/una/fantasydefender/resource/visuals/icon.png")
        ));
    }
